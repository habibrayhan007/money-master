...
function calculateFoodCost (){
    const foodCostInput = document.getElementById("input-food");
...
function calculateRent(){
    const rentCostInput = document.getElementById("input-rent");
...
function calculateClothesCost(){
    const clothesCostInput = document.getElementById("input-cloth");
...
function calculateSavingratio(){
    const savingInput = document.getElementById("input-saving");
    ...
    const savingAmount = (income * savingRatio) / 100 ;
     ...
     if ( savingRatio < 1){
        ...
        if ( savingAmount > balance){
            window.alert("You can not save this amount becaause you already spend more than this amount")
        }
        else{
